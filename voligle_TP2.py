"""
voligle_tp2 — production dashboard for the locked strategy.
...
Run:
  streamlit run voligle_tp2.py --server.port 8506
"""
...
st.set_page_config(page_title="voligle TP2", layout="wide")
...
# ============================================================
st.markdown("# 🔒 voligle_tp2 — Production Strategy Dashboard")
...
with dl1:
    st.download_button(
        ...
        file_name="voligle_tp2_trades.csv",
        mime="text/csv",
        use_container_width=True,
    )
with dl2:
    st.download_button(
        ...
        file_name="voligle_tp2_summary.csv",
        mime="text/csv",
        use_container_width=True,
    )
with dl3:
    st.download_button(
        ...
        file_name="voligle_tp2_monthly.csv",
        mime="text/csv",
        use_container_width=True,
    )
